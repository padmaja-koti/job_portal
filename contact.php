					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> vidaynagar, <br/>Hubli</address>
								</li>
								<li>
										<h5>Email</h5><a href="jobprotal123@gmail.com">jobprotal123@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+91 1234567890">+91 1234567890</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : vidaynagar Hubli</p>
								<p>Email : <a href="jobprotal123@gmail.com">jobprotal123h23@gmail.com</a></p>
